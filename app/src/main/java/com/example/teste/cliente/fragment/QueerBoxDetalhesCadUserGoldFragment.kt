 ...
 */
class QueerBoxDetalhesCadUserGoldFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view:View = inflater.inflate(R.layout.fragment_queer_box_detalhes_cad_user_gold, container, false)

        val btnSalvar = view.findViewById<View>(R.id.btnSalvar) as Button
        btnSalvar.setOnClickListener {
            assinarCaixaGold(view)
        }
    ...
    fun assinarCaixaGold(view: View){
        val nomeC = nomeG.text.toString().trim()
        val diaAss = diaAssG.text.toString().trim()



        val assinantesQueerBox = FirebaseDatabase.getInstance().getReference("Queer Box Gold/Assinantes")
