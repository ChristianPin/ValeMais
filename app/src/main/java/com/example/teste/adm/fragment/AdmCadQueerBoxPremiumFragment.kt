...
import com.example.teste.adapter.ListaProdutoQueerBoxPremiumAdapter
 ...
 */
class AdmCadQueerBoxPremiumFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_adm_cad_queer_box, container, false)
    ...
    private fun preencherRecyclerView(view: View) {
        ...
        val adapter = ListaProdutoQueerBoxPremiumAdapter(activity!!, listQueerBox)
