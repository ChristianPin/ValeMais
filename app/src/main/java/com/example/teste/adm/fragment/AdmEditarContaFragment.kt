...
import kotlinx.android.synthetic.main.fragment_adm_editar_conta.*
import java.util.*

/**
 * A simple [Fragment] subclass.
 */
class AdmEditarContaFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_adm_editar_conta, container, false)

        val btnCancelar = view.findViewById<View>(R.id.btnCancelar) as Button
        btnCancelar.setOnClickListener {
            val fragment = AdmAjustesFragment()
